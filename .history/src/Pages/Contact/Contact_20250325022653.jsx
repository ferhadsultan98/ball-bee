    ...
    <div className="contact">
      ...
      <div className="contact-hero">
        <div className="hero-overlay">
          <h1>Əlaqə</h1>
          <p>Təbiətin şirinliyini bizimlə paylaşın!</p>
        </div>
        ...
        <div className="contact-container">
          <div className="contact-info">
            <div className="contact-logo">
              ...
              <h2 className="brand-name">Bal-Bee</h2>
              <p className="brand-tagline">Təbii Balın Ünvanı</p>
            </div>
              ...
              <div className="contact-details">
                ...
                <div className="contact-row">
                  <div className="contact-item">
                    ...
                    <div>
                      <strong>Ünvan:</strong>
                      <p>123 Təbii Bal Küçəsi, Bakı, Azərbaycan</p>
                      <a
                ...
                <div className="contact-row">
                  <div className="contact-item">
                    ...
                    <div>
                      ...
                      <a href="https://ballbee.com" target="_blank" rel="noopener noreferrer">
                        www.ballbee.com
                      </a>
                    </div>
                  </div>
