          ...
          <div className="about-content">
            <div className="about-text">
              ...
              <ul className="benefits-list">
                ...
                <li><strong>{t('about.benefittwohead')}</strong> {t('about.benefittwodesc')}</li>
                <li><strong>{t('about.benefitthreehead')}</strong> {t('about.benefitthreedesc')}</li>
                <li><strong>{t('about.benefitfourhead')}</strong> {t('about.benefitfourdesc')}</li>
                <li><strong>{t('about.benefitfivehead')}</strong> {t('about.benefitfivedesc')}</li>
              </ul>
            </div>
