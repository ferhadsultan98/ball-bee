...
const Products = () => {
  ...
  // Function to create the WhatsApp URL with a pre-filled message
  const createWhatsAppLink = (productName) => {
    const phoneNumber = "0555254193"; // Replace with the desired phone number
    const message = `Salam ${productName} ucun yazirdim size. Tel: ile bilmrem olurmu`; // The pre-filled message
