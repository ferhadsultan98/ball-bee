...
const Products = () => {
  ...
  const createWhatsAppLink = (productName) => {
    const phoneNumber = "+994 50 300 74 30"; // Replace with the desired phone number
    const message = `Salam ${productName} məhsulu üçün yazırdım sizə.`; // The pre-filled message
