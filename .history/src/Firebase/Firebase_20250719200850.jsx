...
import { getDatabase, ref, set, onValue, update, remove, increment, push } from "firebase/database";
...
export { db, auth, analytics, ref, set, onValue, update, remove, increment };