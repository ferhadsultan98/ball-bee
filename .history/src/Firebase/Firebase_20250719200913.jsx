...
import { getDatabase, ref, set, onValue, update, remove, push, increment } from "firebase/database";
...
export { db, auth, analytics, ref, set, onValue, update, remove, push, increment };