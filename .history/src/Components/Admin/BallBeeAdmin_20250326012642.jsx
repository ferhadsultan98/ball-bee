    ...
    <div className="admin-panel">
      ...
      <div className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <nav className="sidebar-nav">
          <NavLink
            to="/admin/gallery" // Use absolute path to stay within admin context
          ...
          <NavLink
            to="/admin/products" // Use absolute path to stay within admin context
            className={({ isActive }) => (isActive ? 'nav-link active' : 'nav-link')}
            onClick={() => setSidebarOpen(false)}
          >
            Products
      ...
      <div className="main-content">
        ...
        <Routes>
          <Route
            path="/gallery" // Match /admin/gallery
            element={
              <GallerySection
          ...
          />
          <Route
            path="/products" // Match /admin/products
