...
const ProductsAdmin = () => {
  ...
  const handleAddOrSaveProduct = async () => {
    if (
      ...
      !formProduct.details || // Validate new field
      !formProduct.price ||
      !formProduct.image
    ) {
  ...
  const handleEditProduct = (index) => {
    ...
    setFormProduct({
      ...
      details: products[index].details || "", // Include details for editing
    });
  };
    ...
    <div className="products-admin">
      ...
      <div className="form-section">
        ...
        <textarea
          ...
          onChange={(e) =>
            setFormProduct((prev) => ({ ...prev, details: e.target.value }))
          }
        />
        <input
          type="text"
          ...
          products.map((product, index) => (
            <div key={index} className="product-card">
              ...
              <div className="card-content">
                ...
                <p className="details">{product.details}</p> {/* New field */}
