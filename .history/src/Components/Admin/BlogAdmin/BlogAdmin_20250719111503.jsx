...
const BlogAdmin = () => {
  ...
  const uploadImage = async (file) => {
    // Burada Firebase Storage ə inteqrasiya edə bilərsən
    return URL.createObjectURL(file); // demo üçün lokal URL
  };
              ...
              <div key={post.id} className="postItem">
                ...
                <div className="postDetails">
                  ...
                  <div className="postMeta">
                    <span>{post.date}</span> | <span>{post.author}</span> | <span>{post.hashtags}</span>
                  </div>
