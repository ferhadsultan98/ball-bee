...
const BlogAdmin = () => {
  ...
  const handleEditorChange = (content, name, lang) => {
    if (editingPost) {
      setEditingPost({
        ...editingPost,
  ...
  const updatePost = async (e) => {
    e.preventDefault();
    if (!editingPost.title.en || !editingPost.excerpt.en || !editingPost.content.en || !editingPost.image) {
      setError('All English fields and image are required.');
      return;
    }
    try {
              ...
              <div key={lang} className="languageSection">
                ...
                <div className="formGroup">
                  ...
                  <ReactQuill
                    ...
                    onChange={(content) => handleEditorChange(content, 'content', lang)}
            ...
            <div className="formGroup">
              ...
              {(editingPost?.image || newPost.image) && (
                <div className="image-preview">
                  <img src={editingPost ? editingPost.image : newPost.image} alt="Preview" />
                  {editingPost && (
                    <button
                    type="button"
